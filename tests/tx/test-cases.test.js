...
describe('parameters', () => {
  ...
  it('parameters-expand-supplement-none', async () => {
    await runTest({"suite":"parameters","test":"parameters-expand-supplement-none"});
  });

  it('parameters-expand-supplement-good', async () => {
    await runTest({"suite":"parameters","test":"parameters-expand-supplement-good"});
  });

  it('parameters-expand-supplement-bad', async () => {
    await runTest({"suite":"parameters","test":"parameters-expand-supplement-bad"});
  });

  it('parameters-validate-supplement-none', async () => {
    await runTest({"suite":"parameters","test":"parameters-validate-supplement-none"});
  });

  it('parameters-validate-supplement-good', async () => {
    await runTest({"suite":"parameters","test":"parameters-validate-supplement-good"});
  });

  it('parameters-validate-supplement-bad', async () => {
    await runTest({"suite":"parameters","test":"parameters-validate-supplement-bad"});
  });

  it('parameters-lookup-supplement-none', async () => {
    await runTest({"suite":"parameters","test":"parameters-lookup-supplement-none"});
  });

  it('parameters-lookup-supplement-good', async () => {
    await runTest({"suite":"parameters","test":"parameters-lookup-supplement-good"});
  });

  it('parameters-lookup-supplement-bad', async () => {
    await runTest({"suite":"parameters","test":"parameters-lookup-supplement-bad"});
  });
...
describe('notSelectable', () => {
  ...
  it('notSelectable-prop-true-true-param-true', async () => {
    await runTest({"suite":"notSelectable","test":"notSelectable-prop-true-true-param-true"});
  });

  it('notSelectable-prop-true-true-param-false', async () => {
    await runTest({"suite":"notSelectable","test":"notSelectable-prop-true-true-param-false"});
  });

  it('notSelectable-prop-false-false-param-true', async () => {
    await runTest({"suite":"notSelectable","test":"notSelectable-prop-false-false-param-true"});
  });

  it('notSelectable-prop-false-false-param-false', async () => {
    await runTest({"suite":"notSelectable","test":"notSelectable-prop-false-false-param-false"});
  });
...
describe('bugs', () => {
  ...
  it('lang-case2', async () => {
    await runTest({"suite":"bugs","test":"lang-case2"});
  });
...
describe('permutations', () => {
  ...
  it('bad-cc1-all-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc1-all-request"});
  });

  it('bad-cc1-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc1-enumerated-request"});
  });

  it('bad-cc1-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc1-exclude-filter-request"});
  });

  it('bad-cc1-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc1-exclude-import-request"});
  });

  it('bad-cc1-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc1-exclude-list-request"});
  });

  it('bad-cc1-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc1-import-request"});
  });

  it('bad-cc1-isa-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc1-isa-request"});
  });

  it('bad-cc2-all-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc2-all-request"});
  });

  it('bad-cc2-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc2-enumerated-request"});
  });

  it('bad-cc2-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc2-exclude-filter-request"});
  });

  it('bad-cc2-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc2-exclude-import-request"});
  });

  it('bad-cc2-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc2-exclude-list-request"});
  });

  it('bad-cc2-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc2-import-request"});
  });

  it('bad-cc2-isa-request', async () => {
    await runTest({"suite":"permutations","test":"bad-cc2-isa-request"});
  });

  it('bad-coding-all-request', async () => {
    await runTest({"suite":"permutations","test":"bad-coding-all-request"});
  });

  it('bad-coding-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"bad-coding-enumerated-request"});
  });

  it('bad-coding-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"bad-coding-exclude-filter-request"});
  });

  it('bad-coding-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-coding-exclude-import-request"});
  });

  it('bad-coding-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"bad-coding-exclude-list-request"});
  });

  it('bad-coding-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-coding-import-request"});
  });

  it('bad-coding-isa-request', async () => {
    await runTest({"suite":"permutations","test":"bad-coding-isa-request"});
  });

  it('bad-scd-all-request', async () => {
    await runTest({"suite":"permutations","test":"bad-scd-all-request"});
  });

  it('bad-scd-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"bad-scd-enumerated-request"});
  });

  it('bad-scd-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"bad-scd-exclude-filter-request"});
  });

  it('bad-scd-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-scd-exclude-import-request"});
  });

  it('bad-scd-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"bad-scd-exclude-list-request"});
  });

  it('bad-scd-import-request', async () => {
    await runTest({"suite":"permutations","test":"bad-scd-import-request"});
  });

  it('bad-scd-isa-request', async () => {
    await runTest({"suite":"permutations","test":"bad-scd-isa-request"});
  });

  it('good-cc1-all-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc1-all-request"});
  });

  it('good-cc1-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc1-enumerated-request"});
  });

  it('good-cc1-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc1-exclude-filter-request"});
  });

  it('good-cc1-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc1-exclude-import-request"});
  });

  it('good-cc1-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc1-exclude-list-request"});
  });

  it('good-cc1-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc1-import-request"});
  });

  it('good-cc1-isa-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc1-isa-request"});
  });

  it('good-cc2-all-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc2-all-request"});
  });

  it('good-cc2-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc2-enumerated-request"});
  });

  it('good-cc2-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc2-exclude-filter-request"});
  });

  it('good-cc2-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc2-exclude-import-request"});
  });

  it('good-cc2-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc2-exclude-list-request"});
  });

  it('good-cc2-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc2-import-request"});
  });

  it('good-cc2-isa-request', async () => {
    await runTest({"suite":"permutations","test":"good-cc2-isa-request"});
  });

  it('good-coding-all-request', async () => {
    await runTest({"suite":"permutations","test":"good-coding-all-request"});
  });

  it('good-coding-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"good-coding-enumerated-request"});
  });

  it('good-coding-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"good-coding-exclude-filter-request"});
  });

  it('good-coding-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-coding-exclude-import-request"});
  });

  it('good-coding-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"good-coding-exclude-list-request"});
  });

  it('good-coding-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-coding-import-request"});
  });

  it('good-coding-isa-request', async () => {
    await runTest({"suite":"permutations","test":"good-coding-isa-request"});
  });

  it('good-scd-all-request', async () => {
    await runTest({"suite":"permutations","test":"good-scd-all-request"});
  });

  it('good-scd-enumerated-request', async () => {
    await runTest({"suite":"permutations","test":"good-scd-enumerated-request"});
  });

  it('good-scd-exclude-filter-request', async () => {
    await runTest({"suite":"permutations","test":"good-scd-exclude-filter-request"});
  });

  it('good-scd-exclude-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-scd-exclude-import-request"});
  });

  it('good-scd-exclude-list-request', async () => {
    await runTest({"suite":"permutations","test":"good-scd-exclude-list-request"});
  });

  it('good-scd-import-request', async () => {
    await runTest({"suite":"permutations","test":"good-scd-import-request"});
  });

  it('good-scd-isa-request', async () => {
    await runTest({"suite":"permutations","test":"good-scd-isa-request"});
  });
